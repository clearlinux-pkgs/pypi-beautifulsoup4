...
Source0  : https://files.pythonhosted.org/packages/b3/ca/824b1195773ce6166d388573fc106ce56d4a805bd7427b624e063596ec58/beautifulsoup4-4.12.3.tar.gz
...
%prep
%setup -q -n beautifulsoup4-4.12.3
cd %{_builddir}/beautifulsoup4-4.12.3
pushd ..
cp -a beautifulsoup4-4.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705585364
