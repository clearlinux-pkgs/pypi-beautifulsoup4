...
Source0  : https://files.pythonhosted.org/packages/c5/4c/b5b7d6e1d4406973fb7f4e5df81c6f07890fa82548ac3b945deed1df9d48/beautifulsoup4-4.12.0.tar.gz
...
%prep
%setup -q -n beautifulsoup4-4.12.0
cd %{_builddir}/beautifulsoup4-4.12.0
pushd ..
cp -a beautifulsoup4-4.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679325786
